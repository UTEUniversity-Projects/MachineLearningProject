...
parser.add_argument('-r', '--data', type=str, default='./dataset/ImageNet3Classes', help='path to dataset')
#parser.add_argument('-r', '--data', type=str, default='../../datasets/ImageNet100Classes', help='path to dataset')
...
def main():
    ...
    args.arch = 'MyNet_Dog_Cat_Squirrel_Net01_03'
...
def accuracy(output, target, topk=(1,)):
    ...
    with torch.no_grad():
        ...
        #print('vaoday' + str(output))
        #print('vaoday:' + str(maxk))
